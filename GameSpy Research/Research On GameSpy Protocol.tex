...
\begin{figure}[H]
	...
	\scalebox{0.8}{
		...
		\node[block,right=20pt of c] (d) {Recv Buddy Status};
		...
		\node[block,below=20pt of h] (j) {Recv Buddy Status Info};
...
\subsection{Buddy Status}
\subsection{Buddy Status Info}
...
\begin{tcolorbox}
	...
	\begin{split}
	&\backslash search\backslash\backslash sesskey \backslash \langle \rangle\backslash profileid \backslash \langle \rangle \\ &\backslash namespaceid\backslash \langle \rangle  \backslash partnerid\backslash \langle \rangle\\
...
\begin{tcolorbox}
	...
	\begin{split}
&\backslash bsr \backslash \langle profileid \rangle \backslash nick \backslash \langle nick \rangle \backslash 
	\end{split}
	\end{equation}
\end{tcolorbox}
