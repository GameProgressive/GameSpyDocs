...
\begin{figure}[H]
	...
	\node[block, right= of qr](sb){SB};
	%%%%%%%%%%%left nodes%%%%%%%%%%%
	\node[block,left= of gpcm](cdkey){CDKey};
	...
	%%%%%%%%%%%lines%%%%%%%%%%%%%
	\draw[line] (client)--(gpcm);
	\draw[line](client)--(gpsp);
	\draw[line](client)--(cdkey);
	\draw[line](client)--(chat);
	\draw[line](client)--node [midway, above, sloped] {\circled{\small{1}}\circled{\small{3}}} (qr);
	\draw[line](client)--(sb);
	
	\draw[line](client)--(gstats);
	\draw[line](client)--(webserver);
	...
	\draw[line](gameserver)--(qr);
	\draw[line](client)--(gameserver);
	\draw[line](gameserver)--(cdkey);
