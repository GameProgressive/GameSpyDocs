...
\begin{figure}[H]
	...
	\scalebox{0.8}{
		...
		\draw[line] ([xshift = -15]a.south)--node [midway, below, sloped] {Client2 connect request} ([xshift=10]b.north);
		
		\draw[line] ([xshift=-10]b.north)--node [midway, above, sloped] {Heat beat} ([xshift = -35]a.south);
		
		\draw[line] ([xshift =15]a.south)--node[midway, below, sloped] {Client 1 connect request} ([xshift=-10]c.north);
		\draw[line] ([xshift=10]c.north) -- node[midway, above, sloped] {Heart beat} ([xshift=35]a.south);
		
		
		\draw[line] ([yshift=8]b.east)--node[fill=white]{Connect to each other}([yshift=8]c.west);
		
		\draw[line] ([yshift=-8]c.west)--node[fill=white]{Connect to each other}([yshift=-8]b.east);
