...
\chapter{The History of GameSpy}
...
\chapter{The Access Sequence of Client}
...
\tbs blk\tbs <number of profile id>\tbs list\tbs<profileid 1>,
\\<profileid 2>,$ \cdots $,<profileid n>\tbs final\tbs
\end{mybox}
...
\begin{appendix}
\part{Login Proof Challenge Generation Algorithm}\label{Login Proof Challenge Gerneration Algorithm}
\part{Gstats Initial Encryption}
\part{CDKey Server Initial Encryption}
\end{appendix}
